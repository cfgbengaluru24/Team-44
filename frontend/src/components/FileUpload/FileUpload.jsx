...
function FileUpload() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
      <form onSubmit={handleSubmit} encType="multipart/form-data" className="bg-[#e9edc9] shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <div className="mb-4">
          <input
            type="file"
            name="file"
        ...
        <div className="flex items-center justify-between">
          <button
            type="submit"
            className="bg-[#588157] hover:bg-[#3a5a40] text-white font-bold py-2 px-4 rounded focus:outline-none"
          >
            Upload
          </button>
        </div>
